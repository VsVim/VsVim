    ...
    static let SharedStandardCommands =
        let normalSeq = 
            seq {
                ...
                yield ("gh", CommandFlags.Special, NormalCommand.SwitchMode (ModeKind.SelectCharacter, SwitchCommandModeArgument.None))
                yield ("gH", CommandFlags.Special, NormalCommand.SwitchMode (ModeKind.SelectLine, SwitchCommandModeArgument.None))
                yield ("g<C-h>", CommandFlags.Special, NormalCommand.SwitchMode (ModeKind.SelectBlock, SwitchCommandModeArgument.None))
                ...
                yield (":", CommandFlags.Special, NormalCommand.SwitchMode (ModeKind.Command, SwitchCommandModeArgument.FromNormalMode))
