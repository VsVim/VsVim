    ...
    static let SharedStandardCommands =
        let normalSeq = 
            seq {
                ...
                yield ("<C-w><Down>", CommandFlags.None, NormalCommand.GoToView Direction.Down)
                ...
                yield ("<C-w><Up>", CommandFlags.None, NormalCommand.GoToView Direction.Up)
                ...
                yield ("<C-w><Right>", CommandFlags.None, NormalCommand.GoToView Direction.Right)
                yield ("<C-w><C-h>", CommandFlags.None, NormalCommand.GoToView Direction.Left)
                yield ("<C-w>h", CommandFlags.None, NormalCommand.GoToLastView Direction.Left)
                yield ("<C-w><Left>", CommandFlags.None, NormalCommand.GoToLastView Direction.Left)
                yield ("<C-w>J", CommandFlags.None, NormalCommand.GoToLastView Direction.Down)
                yield ("<C-w>K", CommandFlags.None, NormalCommand.GoToLastView Direction.Up)
                yield ("<C-w>L", CommandFlags.None, NormalCommand.GoToLastView Direction.Right)
                yield ("<C-w>H", CommandFlags.None, NormalCommand.GoToLastView Direction.Left)
