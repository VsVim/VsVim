    ...
    static let SharedStandardCommands =
        let normalSeq = 
            seq {
                ...
                yield ("]`", CommandFlags.Movement, NormalCommand.JumpToNextMark)
                yield ("[`", CommandFlags.Movement, NormalCommand.JumpToPreviousMark)
                yield ("]'", CommandFlags.Movement, NormalCommand.JumpToNextMarkLine)
                yield ("['", CommandFlags.Movement, NormalCommand.JumpToPreviousMarkLine)
