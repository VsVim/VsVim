...
type internal MotionCapture(_vimBufferData: IVimBufferData, _incrementalSearch: IIncrementalSearch) =
    ...
    static let SharedMotions =
        let motionSeq: (string * MotionFlags * Motion) seq =
            seq {
                yield ("ab", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.Paren)
                yield ("aB", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.CurlyBracket)
                yield ("at", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.TagBlock TagBlockKind.All)
                ...
                yield ("aw", MotionFlags.TextObject ||| MotionFlags.TextObjectWithLineToCharacter,
                       Motion.AllWord WordKind.NormalWord)
                yield ("aW", MotionFlags.TextObject ||| MotionFlags.TextObjectWithLineToCharacter,
                       Motion.AllWord WordKind.BigWord)
                yield ("a\"", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.QuotedString '"')
                yield ("a'", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.QuotedString '\'')
                yield ("a`", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.QuotedString '`')
                yield ("a]", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.Bracket)
                yield ("a[", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.Bracket)
                yield ("a)", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.Paren)
                yield ("a(", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.Paren)
                yield ("a<", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.AngleBracket)
                yield ("a>", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.AngleBracket)
                yield ("a{", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.AllBlock BlockKind.CurlyBracket)
                ...
                yield ("ib", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.Paren)
                yield ("iB", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.CurlyBracket)
                yield ("it", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.TagBlock TagBlockKind.Inner)
                yield ("ip", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysLine, Motion.InnerParagraph)
                yield ("iw", MotionFlags.TextObject ||| MotionFlags.TextObjectWithLineToCharacter,
                       Motion.InnerWord WordKind.NormalWord)
                yield ("iW", MotionFlags.TextObject ||| MotionFlags.TextObjectWithLineToCharacter,
                       Motion.InnerWord WordKind.BigWord)
                yield ("i\"", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                ...
                yield ("i`", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.QuotedStringContents '`')
                yield ("i]", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.Bracket)
                yield ("i[", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.Bracket)
                yield ("i)", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.Paren)
                yield ("i(", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.Paren)
                yield ("i<", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.AngleBracket)
                yield ("i>", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.AngleBracket)
                yield ("i{", MotionFlags.TextObject ||| MotionFlags.TextObjectWithAlwaysCharacter,
                       Motion.InnerBlock BlockKind.CurlyBracket)
                ...
                yield ("[(", MotionFlags.CaretMovement,
                       Motion.UnmatchedToken(SearchPath.Backward, UnmatchedTokenKind.Paren))
                yield ("[{", MotionFlags.CaretMovement,
                       Motion.UnmatchedToken(SearchPath.Backward, UnmatchedTokenKind.CurlyBracket))
                yield ("]]", MotionFlags.CaretMovement, Motion.SectionForward)
                yield ("][", MotionFlags.CaretMovement, Motion.SectionForwardOrCloseBrace)
                yield ("])", MotionFlags.CaretMovement,
                       Motion.UnmatchedToken(SearchPath.Forward, UnmatchedTokenKind.Paren))
                yield ("]}", MotionFlags.CaretMovement,
                       Motion.UnmatchedToken(SearchPath.Forward, UnmatchedTokenKind.CurlyBracket))
    ...
    let ComplexMotions =
        ...
        let motionSeq: (string * MotionFlags * BindDataStorage<Motion>) seq =
            seq {
                ...
                yield ("'", MotionFlags.None, GetLocalMark(fun localMark -> Motion.MarkLine localMark)) // Cursor movement has different semantics than the motion
                yield ("`", MotionFlags.None, GetLocalMark(fun localMark -> Motion.Mark localMark)) // Cursor movement has different semantics than the motion
                yield ("/", MotionFlags.CaretMovement ||| MotionFlags.HandlesEscape,
    ...
    let RecursiveMotions =
        ...
        let getStorage (mapFunc: Motion -> Motion) =
            let bindData =
                { KeyRemapMode = KeyRemapMode.None
                  BindFunction = GetMotionCore coreMotionBindingsMap }
    ...
    let MotionBindings = Seq.append SharedMotions (Seq.append ComplexMotions RecursiveMotions) |> List.ofSeq
