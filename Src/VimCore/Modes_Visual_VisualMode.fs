    ...
    static let SharedCommands = 
        let visualSeq = 
            seq {
                ...
                yield ("gp", CommandFlags.Repeatable, VisualCommand.PutOverSelection (true, true))
                yield ("gP", CommandFlags.Repeatable, VisualCommand.PutOverSelection (true, false))
                ...
                yield ("p", CommandFlags.Repeatable, VisualCommand.PutOverSelection (false, true))
                yield ("P", CommandFlags.Repeatable, VisualCommand.PutOverSelection (false, false))
