...
type internal GlobalSettings() =
    ...
    static let GlobalSettingInfoList = 
        [|
            ...
            (PathName,"pa", SettingValue.String ".,,", SettingOptions.None)
            ...
            (VimRcName, VimRcName, SettingValue.String(StringUtil.Empty), SettingOptions.None)
            (VimRcPathsName, VimRcPathsName, SettingValue.String(StringUtil.Empty), SettingOptions.None)
