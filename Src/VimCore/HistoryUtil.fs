    ...
    static let _keyInputMap = 
        ...
        let set2 =
            ...
            |> Seq.map (fun (name, command) -> 
                ...
                let keyInput2 = KeyInputUtil.ApplyModifiers keyInput1 VimKeyModifiers.Shift
                let keyInput3 = KeyInputUtil.ApplyModifiers keyInput1 VimKeyModifiers.Control
                let keyInput4 = KeyInputUtil.ApplyModifiers keyInput1 (VimKeyModifiers.Shift ||| VimKeyModifiers.Control)
                seq { 
