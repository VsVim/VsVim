...
namespace Vim.VisualStudio.Implementation.Misc
{
    ...
    internal sealed class ReportDesignerUtil : IReportDesignerUtil
    {
        ...
        static ReportDesignerUtil()
        {
            ...
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.PageUp, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.PageDown));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.PageDown, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.End));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.End, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.End, VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.End, VimKeyModifiers.Control | VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.Home));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Home, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Home, VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Home, VimKeyModifiers.Control | VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.Left));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Left, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Left, VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Left, VimKeyModifiers.Control | VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.Right));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Right, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Right, VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Right, VimKeyModifiers.Control | VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.Up));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Up, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.VimKeyToKeyInput(VimKey.Down));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToVimKey(VimKey.Down, VimKeyModifiers.Shift));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToChar('a', VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToChar('v', VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToChar('x', VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToChar('y', VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToChar('z', VimKeyModifiers.Control));
            SpecialHandledSet.Add(KeyInputUtil.ApplyModifiersToChar('z', VimKeyModifiers.Control | VimKeyModifiers.Shift));
