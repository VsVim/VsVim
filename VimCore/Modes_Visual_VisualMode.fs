    ...
    member x.CreateCommandBindings() =
        let visualSeq = 
            seq {
                ...
                yield ("gp", CommandFlags.Repeatable, VisualCommand.PutAfterSelection true)
                yield ("gP", CommandFlags.Repeatable, VisualCommand.PutBeforeSelection true)
                ...
                yield ("p", CommandFlags.Repeatable, VisualCommand.PutAfterSelection false)
                yield ("P", CommandFlags.Repeatable, VisualCommand.PutBeforeSelection false)
