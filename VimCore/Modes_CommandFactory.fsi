...
type internal CommandFactory =
    new : ICommonOperations * IMotionCapture * IIncrementalSearch * IJumpList * IVimLocalSettings -> CommandFactory
    ...
    member CreateMovementCommands : unit -> Command seq

    /// Returns the sequence of shared edit commands for normal mode
    member CreateEditCommandsForNormalMode  : unit -> Command seq

    /// Returns the sequence of shared edit commands for visual mode
    member CreateEditCommandsForVisualMode  : VisualKind -> Command seq
