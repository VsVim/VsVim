...
type internal Vim
    ...
    member x.CreateVimBufferCore view = 
        ...
        let insertOpts = Modes.Insert.DefaultOperations(view,editOperations,_host) :> Modes.ICommonOperations
        let visualOptsFactory kind = 
            ...
            Modes.Visual.DefaultOperations(view,editOperations,_host, tracker) :> Modes.Visual.IOperations
