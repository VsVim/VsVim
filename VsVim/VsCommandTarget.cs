...
namespace VsVim
{
    ...
    internal sealed class VsCommandTarget : IOleCommandTarget
    {
        ...
        internal bool IgnoreNextExecIfEscape { get; set; }
        ...
        int IOleCommandTarget.QueryStatus(ref Guid pguidCmdGroup, uint cCmds, OLECMD[] prgCmds, IntPtr pCmdText)
        {
            ...
            if (1 == cCmds && TryConvert(pguidCmdGroup, prgCmds[0].cmdID, pCmdText, out ki) && _buffer.CanProcess(ki))
            {
                ...
                {
                    // With Resharper installed we need to special case Escape.  They need to process it in order
