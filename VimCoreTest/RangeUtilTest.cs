...
namespace VimCore.Test
{
    ...
    public class RangeUtilTest
    {
        ...
        public void ParseMark4()
        {
            ...
            Assert.AreEqual(_buffer.GetLineRange(0, 1).ExtentIncludingLineBreak, span);
        }
        ...
        public void ParseMark7()
        {
            ...
            Assert.IsTrue(range.IsSucceeded);
            Assert.AreEqual(_buffer.GetLineRange(0).ExtentIncludingLineBreak, RangeUtil.GetSnapshotSpan(range.AsSucceeded().Item1));
        }
