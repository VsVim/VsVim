...
namespace VimCore.Test
{
    ...
    public class TextViewMotionUtilTest
    {
        ...
        public void LineOrFirstToFirstNonWhitespace1()
        {
            ...
            Assert.AreEqual(_buffer.GetLineSpan(0, 1).Extent, data.Span);
            Assert.IsFalse(data.IsForward);
        ...
        public void LineOrFirstToFirstNonWhitespace4()
        {
            ...
            Assert.AreEqual(_buffer.GetLineSpan(0, 0).Extent, data.Span);
            Assert.IsTrue(data.IsForward);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(0, data.Column.Value);
        ...
        public void LineOrLastToFirstNonWhitespace3()
        {
            ...
            Assert.AreEqual(_buffer.GetLineSpan(1, 2).Extent, data.Span);
            Assert.IsTrue(data.IsForward);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(0, data.Column.Value);
        ...
        public void LastNonWhitespaceOnLine1()
        {
            ...
            Assert.AreEqual(_buffer.GetLineSpan(0).Extent, data.Span);
            Assert.IsTrue(data.IsForward);
            Assert.AreEqual(OperationKind.CharacterWise, data.OperationKind);
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
        }
        ...
        public void LineFromTopOfVisibleWindow1()
        {
            ...
            Assert.AreEqual(buffer.GetLineSpan(0).Extent, data.Span);
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.IsTrue(data.IsForward);
        }
        ...
        public void LineFromTopOfVisibleWindow2()
        {
            ...
            Assert.AreEqual(buffer.GetLineSpan(0, 1).Extent, data.Span);
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.IsTrue(data.IsForward);
        }
        ...
        public void LineDownToFirstNonWhitespace1()
        {
            ...
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.AreEqual(_buffer.GetLineSpan(0, 1).ExtentIncludingLineBreak, data.Span);
            Assert.IsTrue(data.IsForward);
        }
        ...
        public void LineDownToFirstNonWhitespace2()
        {
            ...
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.AreEqual(_buffer.GetLineSpan(0, 2).ExtentIncludingLineBreak, data.Span);
            Assert.IsTrue(data.IsForward);
        }
        ...
        public void LineDownToFirstNonWhitespace3()
        {
            ...
            Assert.AreEqual(MotionKind.Inclusive, data.MotionKind);
            Assert.AreEqual(OperationKind.LineWise, data.OperationKind);
            Assert.AreEqual(_buffer.GetLineSpan(0).ExtentIncludingLineBreak, data.Span);
            Assert.IsTrue(data.IsForward);
        }
        ...
        public void LineDownToFirstNonWhitespace4()
        {
            ...
            _textView.MoveCaretTo(1);
            var data = _util.LineDownToFirstNonWhitespace(1);
            var span = _textView.GetLineSpan(0, 1).ExtentIncludingLineBreak;
            Assert.AreEqual(span, data.Span);
        }
        ...
        public void LineDown2()
        {
            ...
            AssertData(
                data,
                _buffer.GetLineSpan(0, 2).ExtentIncludingLineBreak,
                MotionKind.Inclusive,
                OperationKind.LineWise);
        }
        ...
        public void LineUp1()
        {
            ...
            AssertData(
                data,
                _buffer.GetLineSpan(1, 2).ExtentIncludingLineBreak,
                MotionKind.Inclusive,
                OperationKind.LineWise);
        }
        ...
        public void SectionForward1()
        {
            ...
            Assert.AreEqual(_textView.GetLineSpan(0).ExtentIncludingLineBreak, data.Span);
            Assert.AreEqual(0, data.Column.Value);
        }
        ...
        public void SectionForward5()
        {
            ...
            Assert.AreEqual(_textView.GetLineSpan(0, 1).ExtentIncludingLineBreak, data.Span);
            Assert.AreEqual(0, data.Column.Value);
        }
        ...
        public void SectionBackwardOrOpenBrace2()
        {
            ...
            var data = _util.SectionBackwardOrOpenBrace(1);
            Assert.AreEqual(_textView.GetLineSpan(1).ExtentIncludingLineBreak, data.Span);
        }
