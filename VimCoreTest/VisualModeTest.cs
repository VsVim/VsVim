...
namespace VimCore.Test
{
    ...
    public class VisualModeTest
    {
        ...
        {
            Create("foo", "bar");
            var span = _buffer.GetLineSpan(0).Extent;
        ...
        public void Yank_Y_1()
        {
            ...
            _selection.MakeSelection(span);
            Assert.IsTrue(_mode.Process('Y').IsSwitchPreviousMode);
            Assert.AreEqual(_buffer.GetLineSpan(0).GetTextIncludingLineBreak(), _map.GetRegister(RegisterName.Unnamed).StringValue);
        }
        ...
        public void Yank_Y_2()
        {
            ...
            var span = _buffer.GetLineSpan(0).ExtentIncludingLineBreak;
            _selection.MakeSelection(span);
            _mode.Process('y');
        ...
        {
            Create("a", "b", "c", "d", "e");
            var span = _buffer.GetLineSpan(0, 2).Extent;
            _selection.MakeSelection(span);
            _operations
        ...
        {
            Create("a", "b", "c", "d", "e");
            var span = _buffer.GetLineSpan(0, 3).Extent;
            _selection.MakeSelection(span);
            _operations
                .Setup(x => x.JoinSpan(span, JoinKind.RemoveEmptySpaces))
                .Verifiable();
        ...
        public void ChangeCase2()
        {
            ...
            _selection.MakeSelection(
                _buffer.GetLineSpan(0).Extent,
                _buffer.GetLineSpan(1).Extent);
            _operations
        ...
        public void Fold_zF_1()
        {
            ...
            var span = _buffer.GetSpan(0, 1);
            _selection.MakeSelection(span);
            _foldManager.Setup(x => x.CreateFold(_buffer.GetLineSpan(0, 0).ExtentIncludingLineBreak)).Verifiable();
            _mode.Process("zF");
            _factory.Verify();
        }
        ...
        public void Fold_zF_2()
        {
            ...
            var span = _buffer.GetSpan(0, 1);
            _selection.MakeSelection(span);
            _foldManager.Setup(x => x.CreateFold(_buffer.GetLineSpan(0, 1).ExtentIncludingLineBreak)).Verifiable();
            _mode.Process("2zF");
            _factory.Verify();
        }
        ...
        public void FormatSelection1()
        {
            ...
            var span = _buffer.GetLineSpan(0).Extent;
            _selection.MakeSelection(span);
            _host.Setup(x => x.FormatLines(_view.Object, _buffer.GetLineSpan(0, 0))).Verifiable();
            _mode.Process("=");
            _factory.Verify();
        }
        #endregion
