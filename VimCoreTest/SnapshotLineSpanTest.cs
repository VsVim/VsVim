...
namespace VimCore.Test
{
    ...
    public class SnapshotLineSpanTest
    {
        ...
        {
            Create("hello", "world");
            var range = SnapshotLineSpan.CreateForSingleLine(_buffer.CurrentSnapshot, 0);
        ...
        {
            Create("hello", "world");
            var range = SnapshotLineSpan.CreateForSingleLine(_buffer.CurrentSnapshot, 5);
        }
        ...
        {
            Create("hello", "world");
            var range = SnapshotLineSpan.CreateForStartAndCount(_buffer.CurrentSnapshot, 0, 1);
            Assert.AreEqual("hello", range.Extent.GetText());
            Assert.AreEqual(1, range.Count);
            Assert.AreEqual(0, range.StartLineNumber);
            Assert.AreEqual(0, range.EndLineNumber);
        ...
        {
            Create("hello", "world");
            var range = SnapshotLineSpan.CreateForStartAndCount(_buffer.CurrentSnapshot, 0, 2);
        ...
        {
            Create("hello", "world");
            var range = SnapshotLineSpan.CreateForStartAndEndLine(_buffer.CurrentSnapshot, 0, 0);
            Assert.AreEqual("hello", range.Extent.GetText());
            Assert.AreEqual(1, range.Count);
            Assert.AreEqual(0, range.StartLineNumber);
            Assert.AreEqual(0, range.EndLineNumber);
        ...
        {
            Create("hello", "world");
            var range = SnapshotLineSpan.CreateForStartAndEndLine(_buffer.CurrentSnapshot, 0, 1);
            Assert.AreEqual("hello" + Environment.NewLine + "world", range.Extent.GetText());
            Assert.AreEqual(2, range.Count);
            Assert.AreEqual(0, range.StartLineNumber);
            Assert.AreEqual(1, range.EndLineNumber);
