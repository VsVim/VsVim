...
namespace VimCore.Test
{
    ...
    public class FoldManagerTest
    {
        ...
        public void Folds2()
        {
            ...
            var span = _textBuffer.GetLineSpan(0, 1).ExtentIncludingLineBreak;
        ...
        {
            SetUp("the quick brown", "fox jumped", " over the dog");
            var span = _textBuffer.GetLineSpan(0, 1).Extent;
            _manager.CreateFold(span);
            Assert.AreEqual(_textBuffer.GetLineSpan(0, 1).ExtentIncludingLineBreak, _manager.Folds.Single());
        }
        ...
        {
            SetUp("the quick brown", "fox jumped", " over the dog");
            var span1 = _textBuffer.GetLineSpan(0, 1).ExtentIncludingLineBreak;
            _manager.CreateFold(span1);
            var span2 = _textBuffer.GetLineSpan(0, 2).ExtentIncludingLineBreak;
        ...
        {
            SetUp("the quick brown", "fox jumped", " over the dog");
            var span1 = _textBuffer.GetLineSpan(0, 1).Extent;
            _manager.CreateFold(span1);
            var span2 = _textBuffer.GetLineSpan(0, 2).Extent;
            _manager.CreateFold(span2);
