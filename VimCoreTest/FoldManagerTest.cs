...
namespace VimCore.Test
{
    ...
    public class FoldManagerTest
    {
        ...
        public void Folds2()
        {
            ...
            var span = _textBuffer.GetLineSpanIncludingLineBreak(0, 1);
        ...
        {
            SetUp("the quick brown", "fox jumped", " over the dog");
            var span = _textBuffer.GetLineSpan(0, 1);
            _manager.CreateFold(span);
            Assert.AreEqual(_textBuffer.GetLineSpanIncludingLineBreak(0,1), _manager.Folds.Single());
        }
        ...
        {
            SetUp("the quick brown", "fox jumped", " over the dog");
            var span1 = _textBuffer.GetLineSpanIncludingLineBreak(0, 1);
            _manager.CreateFold(span1);
            var span2 = _textBuffer.GetLineSpanIncludingLineBreak(0, 2);
        ...
        {
            SetUp("the quick brown", "fox jumped", " over the dog");
            var span1 = _textBuffer.GetLineSpan(0, 1);
            _manager.CreateFold(span1);
            var span2 = _textBuffer.GetLineSpan(0, 2);
            _manager.CreateFold(span2);
