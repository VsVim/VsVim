...
namespace Vim.UnitTest
{
    public abstract class VimBufferTest : VimTestBase
    {
        ...
        public sealed class KeyInputTest : VimBufferTest
        {
            ...
            {
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
                _vimBuffer.Vim.KeyMap.AddKeyMapping("lad", "rad", allowRemap: false, KeyRemapMode.Normal);
                _textView.SetText("hello world");
        ...
        public sealed class CloseTest : VimBufferTest
        {
            ...
            public void ProcessBufferedCloseCommandShouldRaisePostClosed()
            {
                ...
                _vimBuffer.Vim.KeyMap.AddKeyMapping("Q", "A", allowRemap: false, KeyRemapMode.Normal);
                _vimBuffer.Vim.KeyMap.AddKeyMapping("QQ", "B", allowRemap: false, KeyRemapMode.Normal);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
        ...
        public sealed class MiscTest : VimBufferTest
        {
            ...
            {
                _keyMap.AddKeyMapping("a", "l", allowRemap: false, KeyRemapMode.Normal);
            ...
            {
                _keyMap.AddKeyMapping("a", "dw", allowRemap: false, KeyRemapMode.Normal);
                _textView.SetText("cat dog", 0);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
                _vimBuffer.Process('a');
            ...
            {
                _keyMap.AddKeyMapping("l", "dw", allowRemap: false, KeyRemapMode.Insert);
                _textView.SetText("cat dog", 0);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
                _vimBuffer.Process('l');
                Assert.Equal(1, _textView.GetCaretPoint().Position);
            ...
            {
                _keyMap.AddKeyMapping("z", "w", allowRemap: false, KeyRemapMode.OperatorPending);
                _textView.SetText("cat dog", 0);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
            ...
            {
                _keyMap.AddKeyMapping("a", "b", allowRemap: true, KeyRemapMode.Normal);
                _keyMap.AddKeyMapping("b", "a", allowRemap: true, KeyRemapMode.Normal);
                var didRun = false;
            ...
            {
                _keyMap.AddKeyMapping("do", "cat", allowRemap: false, KeyRemapMode.Normal);
                _textView.SetText("cat dog", 0);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
                _vimBuffer.Process("d");
            ...
            {
                _keyMap.AddKeyMapping("a", "c", allowRemap: true, KeyRemapMode.Normal);
                var keyInput = KeyInputUtil.CharToKeyInput('c');
                var normal = CreateAndAddNormalMode(MockBehavior.Loose);
                normal.Setup(x => x.CanProcess(keyInput)).Returns(true).Verifiable();
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
            ...
            {
                _keyMap.AddKeyMapping("la", "iexample", allowRemap: true, KeyRemapMode.Normal);
            ...
            {
                _vimBuffer.Vim.KeyMap.AddKeyMapping("a", "b", allowRemap: false, KeyRemapMode.Normal);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
                var ranProcessed = false;
                _vimBuffer.KeyInputProcessed +=
                    (unused, args) =>
            ...
            {
                _vimBuffer.Vim.KeyMap.AddKeyMapping("jj", "b", allowRemap: false, KeyRemapMode.Normal);
                _vimBuffer.SwitchMode(ModeKind.Normal, ModeArgument.None);
