...
namespace Vim.UnitTest
{
    public sealed class ChangeTrackerTest : VimTestBase
    {
        ...
        public void LinkedWithNextChange_Simple()
        {
            ...
            var runData2 = VimUtil.CreateCommandRunData(flags: CommandFlags.Repeatable, command: Command.NewInsertCommand(InsertCommand.NewExtraTextChange(TextChange.NewInsert("foo"))));
